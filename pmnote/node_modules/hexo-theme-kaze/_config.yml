...
author_img: /img/logo.png
author_description: TOP产品经理
#------------------------
# Navbar config
#------------------------
menus:
...
comment:
  ...
  gitalk:
    ...
    # en | zh-CN | zh-TW
    language: zh-CN ## navigator.language || navigator.userLanguage
  livere:
    uid:
...
cdn:
  ...
  fslightbox: //cdn.jsdelivr.net/npm/fslightbox@3.1.0/index.min.js
